                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="flex gap-2 p-1 rounded-xl border border-white/10" style={{ background: "rgba(255, 255, 255, 0.03)" }}>
                        <button
                            ...
                            className={`flex-1 py-2.5 rounded-lg text-sm font-medium transition-all ${type === "aporte" ? "bg-blue-500 text-white" : "text-gray-400 hover:text-foreground"}`}
                        >
                            Aporte
                        </button>
                        <button
                            ...
                            className={`flex-1 py-2.5 rounded-lg text-sm font-medium transition-all ${type === "resgate" ? "bg-red-500 text-white" : "text-gray-400 hover:text-foreground"}`}
                        >
                            Resgate
                        </button>
                    </div>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-muted mb-2">Tipo de aplicação</label>
                        <select
                            required
                    ...
                    <div>
                        <label className="block text-sm font-medium text-muted mb-2">Data</label>
                        <input
                            type="date"
                            required
                            value={date}
