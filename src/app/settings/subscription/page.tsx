    ...
    return (
        <div className="min-h-screen p-8">
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted mb-8">Gerencie seu plano e preferências de pagamento</p>
                ...
                >
                    <div className="flex items-start justify-between mb-6">
                        <div>
                            <p className="text-muted text-sm mb-2">Plano Atual</p>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        <div>
                            <p className="text-muted text-sm">Preço Mensal</p>
                    ...
                    <div className="border-t border-white/10 pt-6 mb-6">
                        <p className="text-foreground font-semibold mb-4">Limites do Plano</p>
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-sm text-muted">Transações</p>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-sm text-muted">Cards Dashboard</p>
                                    <p className="text-foreground font-medium">
                    ...
                    <div className="border-t border-white/10 pt-6">
                        <p className="text-foreground font-semibold mb-3">Recursos Inclusos</p>
                ...
                {plan.slug !== 'free' && (
                    <div
                        ...
                        style={{ background: "rgba(255, 255, 255, 0.03)" }}
                    >
                        <h3 className="text-xl font-bold text-foreground mb-4">Informações de Pagamento</h3>
                ...
                <div
                    ...
                    style={{ background: "rgba(255, 255, 255, 0.03)" }}
                >
                    <h3 className="text-lg font-bold text-foreground mb-2">Precisa de Ajuda?</h3>
