          ...
          <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <div
                ...
                style={{
                  borderColor: "color-mix(in srgb, var(--secondary) 32%, transparent)",
                  color: "var(--secondary)",
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                ...
                <span
                  ...
                  style={{ background: "var(--accent)", borderColor: "var(--background-light)" }}
                />
              </button>
          ...
          <div className="min-w-0">
            <section className="mb-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
              <Link
                ...
                style={{
                  background:
                    "linear-gradient(135deg, color-mix(in srgb, var(--success) 14%, transparent), color-mix(in srgb, var(--secondary) 9%, transparent))",
              ...
              <Link
                ...
                style={{
                  background:
                    "linear-gradient(135deg, color-mix(in srgb, var(--danger) 12%, transparent), color-mix(in srgb, var(--accent) 7%, transparent))",
